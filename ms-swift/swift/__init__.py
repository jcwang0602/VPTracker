...
if TYPE_CHECKING:
    ...
    from .arguments import BaseArguments, InferArguments, SftArguments
    from .callbacks import TrainerCallback, callbacks_map
    from .dataset import EncodePreprocessor, load_dataset
    from .infer_engine import (AdapterRequest, InferClient, InferEngine, InferRequest, LmdeployEngine,
    ...
    from .pipelines import infer_main, merge_lora, sft_main
    ...
    _import_structure = {
        ...
        'arguments': ['SftArguments', 'InferArguments', 'BaseArguments'],
        'pipelines': ['sft_main', 'infer_main', 'merge_lora'],
